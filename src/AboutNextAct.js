	...
	return (
		<Box>
			...
			>
				...
				<Paragraph>
					<b>Founded in the spring of 1985 by Lauren Singer '86, Next Act
					began as a small but dedicated musical theater group
					composed of Next House residents.</b> Under Lauren's direction,
					Next Act performed "Anything Goes" as its debut production,
					followed by "The Pajama Game" in the spring of 1986. Upon
					her graduation, Lauren passed the Director's Hat to Ivan
					Deutsch '87 who followed in her footsteps by directing the
					Spring 1987 production of "Sweet Charity". Since that time,
					each Next Act director has continued the tradition of
					passing along the Director's Hat in this manner.
				</Paragraph>
